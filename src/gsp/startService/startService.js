...
class StartService {
  ...
  async init(network, stores, iwanAuth) {
    try {
      ...
      eventService.addEventListener(
        "StoremanServiceInitComplete",
        this.onStoremanServiceInitComplete.bind(this)
      );
      ...
      frameworkService.registerService(
        "TxTaskHandleService",
        txTaskHandleService
      );
      ...
      let iWanOption = await configService.getConfig(
  ...
  async start() {
    try {
      ...
      let checkTxReceiptService = frameworkService.getService(
        "CheckTxReceiptService"
      );
      ...
      let checkDogeTxService =
        frameworkService.getService("CheckDogeTxService");
